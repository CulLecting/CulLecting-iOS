...
class AgeCollectionView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    private let age = ["전체", "어린이/청소년", "가족"]
    ...
    private func setupUI() {
        ...
        ageCollectionView.snp.makeConstraints {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(with: age[indexPath.item])
        // ✅ 선택된 셀만 색상 변경
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("Selected Item: \(age[indexPath.item])") // ✅ 선택된 아이템 로그
